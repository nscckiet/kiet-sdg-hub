const OngoingEvents = () => {
  return (
    <div className="flex px-[60px] py-[95px] shadow-[0px_0px_20px_10px_#00000024] rounded-xl">
        <div className="flex flex-col justify-center w-full mr-[50px]">
            <p className=" text-fontSecondary font-semibold text-3xl">Innotech</p>
            <p className="text-[#3FB181]">2nd Nov,2023</p>
            <p className="text-fontMutedColor font-semibold text-xl mt-[18px]">Kiet Group Of Institutions</p>
        </div>
